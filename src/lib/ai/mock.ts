export type Language = "zh" | "ko" | "en" | "mn";

export const supportedLanguages: Language[] = ["zh", "ko", "en", "mn"];
...
export const mockTranslations: Record<Language, Partial<Record<Language, string>>> = {
  zh: {
    ko: "저는 이 부분을 맡을 수 있지만 교수님의 요구사항을 한 번 더 확인하고 싶어요.",
    en: "I can take this part, but I would like to confirm the professor's requirements once more.",
    mn: "Би энэ хэсгийг хариуцаж чадна, гэхдээ профессорын шаардлагыг дахин нэг удаа баталгаажуулмаар байна.",
  },
  ko: {
...
export const mockDiscussionSummary: Record<Language, string> = {
  ...
  mn: "【1. Хэлэлцүүлгийн шийдвэр】\n- Бүлэг эхлээд илтгэлийн дараалал, материал хариуцах үүрэг, профессорын шаардсан ишлэлийн хэлбэрийг баталгаажуулах хэрэгтэй.\n\n【2. Даалгавар ба хариуцагч】\n- Кейс жишээ: хариуцагч тодорхойгүй\n- Онолын хүрээ: хариуцагч тодорхойгүй\n- Танилцуулга ба дүгнэлт: хариуцагч тодорхойгүй\n- Ишлэлийн хэлбэр шалгах: хариуцагч тодорхойгүй\n\n【3. Профессор / даалгаврын шаардлага】\n- Дурдсан: профессорын шаардсан ишлэлийн хэлбэрийг баталгаажуулах хэрэгтэй.\n- Тодорхойгүй: үнэлгээний шалгуур, өгөх формат, солонгос/англи хураангуй хэрэгтэй эсэх.\n\n【4. Шийдэгдээгүй асуултууд】\n- Үнэлгээний шалгуур юу вэ?\n- Эцсийн өгөх формат юу вэ?\n- Солонгос эсвэл англи хураангуй хэрэгтэй юу?\n\n【5. Дараагийн алхам】\n- Профессорын зарлал эсвэл даалгаврын файлыг оруулах.\n- Файлаас тодорхой шаардлагуудыг гаргах.\n- Хүн бүрийн хариуцах хэсгийг баталгаажуулах.\n- Илтгэлийн дараалал болон ишлэлийн хэлбэрийг баталгаажуулах.",
};
